...
public abstract class MicroService implements Runnable {
    private HashMap<Class,Callback> messageList;//maybe calss to class extend message
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
    	...
    	messageList.putIfAbsent(type,callback);
    }
    ...
    public final void run() {
        ...
        {
            try{
                Message message = MessageBusImpl.getInstance().awaitMessage(this);//waiting for message
                messageList.get(message.getClass()).call(message);//callback
            }
